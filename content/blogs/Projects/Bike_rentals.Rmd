...
- ""
date: "`r Sys.Date()`"
description: Analysis of bikes rates over a period of time # the title that will show up once someone gets to this page
draft: false
image: pic11.png # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work

keywords: ""
slug: "Bike_rent" # slug is the shorthand URL address... no spaces plz
...
As the data under investigation follows a normal distribution, we should use the mean to calculate the expected values. The median would be more applicable if we were working with a skewed distribution, as this would distort the mean.
